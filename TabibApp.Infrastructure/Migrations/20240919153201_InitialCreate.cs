        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFromChatbot = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatbotMessages_Users_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkCertificateUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assistants_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Examination = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalHistoryRecords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayScheduleDto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DayScheduleDto_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_Appointments_Id",
                        column: x => x.Id,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 21, "طب الرياضة" },
                    { 22, "الطب الوقائي" },
                    { 23, "الجراحة التجميلية" },
                    { 24, "الأمراض الجلدية" },
                    { 25, "طب الشيخوخة" },
                    { 26, "طب الأوعية الدموية" },
                    { 27, "الأمراض النفسية" },
                    { 28, "طب العيون" },
                    { 29, "طب الأذن والحنجرة" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatbotMessages_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayScheduleDto_ClinicId",
                table: "DayScheduleDto",
                column: "ClinicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistoryRecords_PatientId",
